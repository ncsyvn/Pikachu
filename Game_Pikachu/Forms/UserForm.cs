...
namespace Game_Pikachu
{
    public partial class UserForm : Form
    {
        ...
        private void buttonStart_Click(object sender, EventArgs e)
        {
            ...
            {
                PlayForm pf = new PlayForm(Load_UserData(this.comboBox1.Text), this.NewName.Text);
                pf.Show();
            }
            else
            {
                PlayForm pf = new PlayForm(Load_UserData(this.comboBox1.Text), this.comboBox1.Text);
                pf.Show();
            }
